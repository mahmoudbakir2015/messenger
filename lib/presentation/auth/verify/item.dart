...
void login(BuildContext context) {
  BlocProvider.of<PhoneAuthCubit>(context).submitOTP(
    BlocProvider.of<PhoneAuthCubit>(context).otpCode,
  );
}

Widget buildIntroTextsVerify({required phoneNumber}) {
  return Column(
...
Widget buildPinCodeFields(BuildContext context) {
  return PinCodeTextField(
    ...
    onCompleted: (submitedCode) {
      BlocProvider.of<PhoneAuthCubit>(context).otpCode = submitedCode;
      print("Completed");
    },
    onChanged: (value) {
      print(value);
  ...
  return BlocListener<PhoneAuthCubit, PhoneAuthState>(
    ...
    listener: (context, state) {
      ...
      if (state is PhoneOTPVerified) {
        ...
        Navigator.of(context).pushReplacementNamed(appMaster);
      }
